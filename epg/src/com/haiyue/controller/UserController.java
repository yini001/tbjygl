...
public class UserController {
	...
	public Json login(User user, HttpServletRequest request, HttpSession session) {
		...
		if (u != null) {
			...
			session.setAttribute(ResourceUtil.getEpgAddress(), sessionInfo);
	...
	public Json modifyCurrentUserPwd(User user) {
		Json j = new Json();
		User u = userService.getById(user.getId());  //找到用户
		if(u!=null){
			u.setPwd(user.getNewpwd());
	...
	@RequestMapping("/modifyCurrentPwd")
